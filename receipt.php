...
<head>
    ...
    <link rel="shortcut icon" href="https://bit.ly/3wAmj5M">
</head>
<body class="d-flex flex-column min-vh-100" style="background-position: center; 
  background-repeat: no-repeat; background-size: cover; background-image: url('https://bit.ly/3sPgu22');">
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark p-3">
        <div class="container-fluid">
        <img class="mr-5"src="https://www.kindpng.com/picc/m/203-2038452_pablo-escobar-clip-art-hd-png-download.png" 
    ...
    <div class="container bg-light mt-5 text-center p-5" style="width:600px;">
        <img class="text-center"src="https://www.kindpng.com/picc/m/203-2038452_pablo-escobar-clip-art-hd-png-download.png" style="widht:100px; height:100px;">
        <h3>Drug Store</h3>
