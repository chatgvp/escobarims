...
<div class="container-fluid p-3 text-center text-light">
    <h2>Welcome to Escobar Inventory Management Dashboard</h2>
</div>
        ...
        <div class="col border p-3 m-3 bg-light row">
            ...
            <div class="row">
                ...
                <div class="col border m-3 p-3">
                    ...
                    <h6>Total Amount of Items: ₱<b><?php echo $total_price?></b></h6><br>
                </div>
            </div>
            <div class="row">
                <div class="col border m-3 p-3">
