<?php
    ...
    $sql = "UPDATE user_table SET user_name='$user_name',user_username='$user_username',user_password='$user_password',
    user_email='$user_email',user_birthday='$user_birthday' WHERE user_id = '$user_id'";
